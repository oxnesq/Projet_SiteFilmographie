...
data class ModelMovie(
    ...
    val popularity: Double,
    val poster_path: String,
    val production_companies: List<ProductionCompanyMovie>,
    val production_countries: List<ProductionCountryMovie>,
    val release_date: String,
    val revenue: Int,
    val runtime: Int,
    val spoken_languages: List<SpokenLanguageMovie>,
    val status: String,
    val tagline: String,
    val title: String,
    val video: Boolean,
